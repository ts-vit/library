# Library: AI, Development & Life

Коллекция выжимок, переводов и учебных материалов по искусственному интеллекту, разработке и личной эффективности.

## Список материалов

| Книга / Статья | Автор | Папка |
| :--- | :--- | :--- |
...
Все рекомендации по внедрению практик из этих материалов в наши проекты (`toshik-babe`, `toshik-chat`) фиксируются в папке [docs_my_skills](./docs_my_skills).
